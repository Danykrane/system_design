...
| Месячная активная аудитория (MAU) | $MAU=TAM\cdot k_{serviceUse}=16{,}479{,}540\cdot7.4\%=1{,}219{,}486$ | 1,219,486 |
| Дневная активная аудитория (DAU) | $DAU=MAU\cdot0.45=1{,}219{,}486\cdot0.45=548{,}769$ | 548,769 |
